    ...
    <aside className={styles.panel} data-lenis-prevent aria-label="지구본 옵션">
      <div className={styles.head}>
        <div>
          ...
          <p className={styles.sub}>파티클 3장 + 바디 평판 · 히어로만</p>
        </div>
      ...
      <Group title="레이어" hint="꺼도 드로우콜은 남고, 화면에서만 숨깁니다.">
      ...
      <Group
        title="크기 · 밝기"
        hint="size 는 화면 높이 대비 배수. intensity 는 파티클만, haze 는 가산 산란, cover 는 바디가 마퀴를 가리는 양."
      >
      ...
      <Group
        title="파티클"
        hint="헤일로(성긴 외곽) · 껍질(바다 포함 구면) · 육지(대륙). 점 크기는 월드 단위, 카메라 z=6 기준 0.03 ≈ 3px."
      >
      ...
      <Group
        title="바디 평판"
        hint="카메라향 원반. 가산이 아니라 일반 합성이라 점 사이로 마퀴가 비치는 걸 막습니다. 젤리 메시가 아닙니다."
        startOpen={false}
      >
      ...
      <Group
        title="모션"
        hint="히어로는 기본 자전이 없습니다(0). 등장 요 0.12 ≈ 7°, 스크롤 요는 진행도 1에서 0.35 rad."
        startOpen={false}
      >
      ...
      <Group
        title="커서 반발"
        hint="NDC. 반경 0.5 ≈ 화면 높이의 25%, 세기 0.06 ≈ 3%. 헐거운 층일수록 많이 밀립니다."
        startOpen={false}
      >
      ...
      <Group
        title="타워 전환"
        hint="히어로 pin 진행도 0~1. 이 구간에서 구체가 확대되며 타워 배경이 됩니다."
        startOpen={false}
      >
