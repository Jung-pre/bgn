...
function Panel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <aside className={clsx(styles.panel, styles.dockLeft)} data-lenis-prevent aria-label="리본 옵션">
      <div className={styles.head}>
        <div>
          <p className={styles.title}>리본 옵션</p>
          <p className={styles.sub}>타워 씬 실크 멤브레인 · 장면 2</p>
        </div>
      ...
      <Group title="색" hint="띠를 따라 길게 흐릅니다. 1은 은은, 3이면 진해집니다. 네 슬라이더를 같이 올리면 파스텔로 섞입니다.">
